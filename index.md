...
<div class="hero">
  ...
  <h1>DevOps Interview Guide</h1>
  <p>A comprehensive, battle-tested reference covering 500+ interview questions with full answers — from Linux fundamentals to AI-powered DevOps.</p>
  ...
  <div class="hero-stats">
    ...
    <div class="stat">
      ...
      <div class="stat-label">JD Modules</div>
    </div>
    <div class="stat">
      <div class="stat-num">167</div>
      <div class="stat-label">OCP Questions</div>
    </div>
  </div>
...
<div class="section-header">
  <h2>🎯 OpenShift &amp; Kubernetes Engineer — Interview Modules</h2>
...
<div class="module-grid">
  ...
  <a href="{{ '/jd-openshift-k8s-engineer/01-OpenShift-Kubernetes-Core' | relative_url }}" class="module-card card-red">
    ...
    <div class="module-card-meta">
      <span class="module-card-count">25 questions</span>
  ...
  <a href="{{ '/jd-openshift-k8s-engineer/02-CICD-Pipelines' | relative_url }}" class="module-card card-blue">
    ...
    <div class="module-card-meta">
      <span class="module-card-count">24 questions</span>
      <span class="module-card-arrow">→</span>
    </div>
  </a>
  ...
  <a href="{{ '/jd-openshift-k8s-engineer/03-Security-Compliance' | relative_url }}" class="module-card card-orange">
    ...
    <div class="module-card-meta">
      <span class="module-card-count">18 questions</span>
      <span class="module-card-arrow">→</span>
    </div>
  </a>
  ...
  <a href="{{ '/jd-openshift-k8s-engineer/06-Scenario-Based' | relative_url }}" class="module-card card-teal">
    ...
    <div class="module-card-meta">
      <span class="module-card-count">15 questions</span>
      <span class="module-card-arrow">→</span>
    </div>
  </a>
  ...
  <a href="{{ '/jd-openshift-k8s-engineer/07-Behavioral' | relative_url }}" class="module-card card-pink">
    ...
    <div class="module-card-meta">
      <span class="module-card-count">14 questions</span>
      <span class="module-card-arrow">→</span>
    </div>
  </a>
  ...
  <a href="{{ '/jd-openshift-k8s-engineer/08-Python-Scripting' | relative_url }}" class="module-card card-yellow">
    ...
    <div class="module-card-meta">
      <span class="module-card-count">20 questions</span>
      <span class="module-card-arrow">→</span>
    </div>
  </a>
